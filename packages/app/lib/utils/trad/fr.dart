const Map<String, String> appStringsFr = {
  ...
  'emojis_empty': 'Aucun emoji pour l\'instant. Uploadez-en un pour commencer.',
  'emojis_upload': 'Uploader un emoji',
  'emojis_upload_name_hint': 'Nom de l\'emoji (lettres, chiffres, _)',
  'emojis_upload_pick_image': 'Choisir une image',
  'emojis_delete_confirm_title': 'Supprimer l\'emoji',
  'emojis_delete_confirm_body':
      'Supprimer :{name}: ? Cette action est irréversible.',
  'emojis_rename_title': 'Renommer l\'emoji',
  'emojis_rename_hint': 'Nouveau nom',
  'emojis_loading_error': 'Échec du chargement des emojis',
  'emojis_upload_error': 'Échec de l\'upload : {error}',
  ...
  // Noms des actions
  'action_name_deleteMessages': 'Supprimer des messages',
  'action_name_createChannel': 'Créer un salon',
  'action_name_updateChannel': 'Modifier un salon',
  'action_name_removeChannel': 'Supprimer un salon',
  'action_name_sendMessage': 'Envoyer un message',
  'action_name_editMessage': 'Modifier un message',
  'action_name_addReaction': 'Ajouter une réaction',
  'action_name_removeReaction': 'Retirer une réaction',
  'action_name_clearAllReactions': 'Retirer toutes les réactions',
  'action_name_banUser': 'Bannir un utilisateur',
  'action_name_unbanUser': 'Débannir un utilisateur',
  'action_name_kickUser': 'Expulser un utilisateur',
  'action_name_muteUser': 'Rendre muet un utilisateur',
  'action_name_unmuteUser': 'Réactiver la parole d\'un utilisateur',
  'action_name_addRole': 'Ajouter un rôle',
  'action_name_removeRole': 'Retirer un rôle',
  'action_name_pinMessage': 'Épingler un message',
  'action_name_updateAutoMod': 'Mettre à jour AutoMod',
  'action_name_updateGuild': 'Mettre à jour le serveur',
  'action_name_listMembers': 'Lister les membres',
  'action_name_getMember': 'Récupérer un membre',
  'action_name_sendComponentV2': 'Envoyer un composant V2',
  'action_name_editComponentV2': 'Modifier un composant V2',
  'action_name_sendWebhook': 'Envoyer via webhook',
  'action_name_editWebhook': 'Modifier un webhook',
  'action_name_deleteWebhook': 'Supprimer un webhook',
  'action_name_listWebhooks': 'Lister les webhooks',
  'action_name_getWebhook': 'Récupérer un webhook',
  'action_name_httpRequest': 'Requête HTTP',
  'action_name_setGlobalVariable': 'Définir une variable globale',
  'action_name_getGlobalVariable': 'Lire une variable globale',
  'action_name_removeGlobalVariable': 'Supprimer une variable globale',
  'action_name_setScopedVariable': 'Définir une variable scopée',
  ...
  'action_name_getMessage': 'Récupérer un message',
  'action_name_unpinMessage': 'Désépingler un message',
  'action_name_createPoll': 'Créer un sondage',
  'action_name_endPoll': 'Clôturer un sondage',
  'action_name_createInvite': 'Créer une invitation',
  'action_name_deleteInvite': 'Supprimer une invitation',
  'action_name_getInvite': 'Récupérer une invitation',
  'action_name_moveToVoiceChannel': 'Déplacer vers un vocal',
  'action_name_disconnectFromVoice': 'Déconnecter du vocal',
  'action_name_serverMuteMember': 'Rendre muet côté serveur',
  'action_name_serverDeafenMember': 'Assourdir côté serveur',
  'action_name_createEmoji': 'Créer un emoji',
  'action_name_updateEmoji': 'Modifier un emoji',
  'action_name_deleteEmoji': 'Supprimer un emoji',
  'action_name_createAutoModRule': 'Créer une règle AutoMod',
  'action_name_deleteAutoModRule': 'Supprimer une règle AutoMod',
  'action_name_listAutoModRules': 'Lister les règles AutoMod',
  'action_name_getGuildOnboarding': 'Récupérer l\'onboarding serveur',
  'action_name_updateGuildOnboarding': 'Modifier l\'onboarding serveur',
  'action_name_updateSelfUser': 'Mettre à jour le profil du bot',
  'action_name_createThread': 'Créer un fil',
  'action_name_editChannelPermissions': 'Modifier les permissions du salon',
  'action_name_deleteChannelPermission': 'Supprimer une permission du salon',
  ...
  // ── Refonte de l'accueil (D/A) ──────────────────────────────────────────
  'home_overline': 'MES PROJETS',
  'home_refresh_tooltip': 'Actualiser',
  'home_docs_tooltip': 'Documentation',
  'home_settings_tooltip': 'Paramètres',
  'home_turnkey_title': 'Bots Clé en main',
  'home_turnkey_subtitle': 'Déployez des bots prêts à l\'emploi',
  ...
  'home_hosting_unit_hour': 'h',
  'home_hosting_unit_minute': 'm',
  'home_manage_app': 'Gérer l\'application',
  'home_start_action': 'Démarrer',
  'home_create_app': 'Créer une application',
  ...
  'bot_settings_presence_status_label': 'Présence',
  ...
  'bot_settings_status_rotation_title': 'Rotation des activités',
  'bot_settings_status_rotation_desc':
      'Ajoutez une ou plusieurs activités. Chaque activité nécessite un type, un nom et un intervalle min/max (secondes).',
  'bot_settings_add_status': 'Ajouter une activité',
  'bot_settings_status_item_title': 'Activité {index}',
  'bot_settings_remove_status': 'Supprimer l\'activité',
  ...
  'bot_settings_status_text_label': 'Nom de l\'activité',
  'bot_settings_activity_state_label': 'État de l\'activité (optionnel)',
  'bot_settings_activity_url_label': 'URL de stream (pour streaming)',
