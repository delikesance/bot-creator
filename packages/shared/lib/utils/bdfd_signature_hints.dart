...
const Map<String, List<String>> bdfdSignatureHints = <String, List<String>>{
  ...
  // ── Other ───────────────────────────────────────────────────────────
  'addcontainer': ['accentColor (opt)', 'spoiler (opt)'],
  'addmediagallery': ['url1', 'url2 (opt)', '...'],
  'addsection': ['accessoryType', 'accessoryData'],
  'addseparator': ['spacing (opt)', 'divider (opt)'],
  'addtextdisplay': ['text'],
  'addthumbnail': ['url', 'description (opt)', 'spoiler (opt)'],
